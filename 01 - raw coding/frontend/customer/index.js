...
fetchAllMenus((menus) => {
  ...
  menusTable.innerHTML =
    "<thead><tr><th>Id</th><th>Name</th><th>create_date</th><th>modify_date</th><th>id_restaurant</th></tr></thead>";
...
fetchAllDishes((dishes) => {
  ...
  dishesTable.innerHTML =
    "<thead><tr><th>Id</th><th>Name</th><th>ingredients</th><th>id_menu</th></tr></thead>";
  let tbody = document.createElement("tbody");
