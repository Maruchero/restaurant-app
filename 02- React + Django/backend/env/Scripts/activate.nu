...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user_\Files\HTML\restaurant-app\02- React + Django\backend\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user_\Files\HTML\restaurant-app\02- React + Django\backend\env\Scripts\deactivate.nu'
